...
export function Item({ index, label }: { index: number; label: string }) {
  ...
  return (
    <div
      className={cn(
        'flex size-20 cursor-pointer items-center justify-center bg-gray-600 text-2xl font-medium text-white hover:border-4 hover:border-blue-800 dark:bg-gray-200 dark:text-gray-800',
        {
